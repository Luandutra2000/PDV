import './config/runtime-config.js?v=20260729-13';
import { renderSidebar } from './components/sidebar.component.js?v=20260729-13';
import { ensureSeedData } from './services/storage.service.js?v=20260729-13';
import { hydrateDataProvider } from './services/data-provider.service.js?v=20260729-13';
import { loadCategories, loadProducts, startCatalogRealtime, syncCatalogNow } from './services/product.service.js?v=20260729-13';
import { hydrateFinancialData, startFinancialRealtime } from './services/financial-sync.service.js?v=20260729-13';
import { isSupabaseEnabled } from './services/app-config.service.js?v=20260729-13';
import { hydrateOnlineOperationalData } from './services/online-data.service.js?v=20260729-13';
import { getDashboardResumo } from './services/dashboard-resumo.service.js?v=20260729-13';
import { initSyncService } from './services/sync.service.js?v=20260729-13';
import { initVendasModule } from './modules/vendas/vendas.module.js?v=20260729-13';
import { initProdutosModule } from './modules/produtos/produtos.module.js?v=20260729-13';
import { initDashboardModule } from './modules/dashboard/dashboard.module.js?v=20260729-13';
import { initEstoqueModule } from './modules/estoque/estoque.module.js?v=20260729-13';
import { initCaixaModule } from './modules/caixa/caixa.module.js?v=20260729-13';
import { initMobileDashboardModule } from './modules/mobile/mobile-dashboard.module.js?v=20260729-13';
import { initPessoasModule } from './modules/pessoas/pessoas.module.js?v=20260729-13';
import { initDespesasModule } from './modules/despesas/despesas.module.js?v=20260729-13';
import { initEmpresaConfigModule } from './modules/empresa-config/empresa-config.module.js?v=20260729-13';
import { initRelatoriosModule } from './modules/relatorios/relatorios.module.js?v=20260729-13';
import { formatCurrency } from './utils/currency.js?v=20260729-13';
import { initNotificationService } from './services/notification.service.js?v=20260729-13';
import { initRealtimeService } from './services/realtime.service.js?v=20260729-13';
import { getThemeLabel, initTheme, toggleTheme } from './services/theme.service.js?v=20260729-13';
import { getDailyMoneySummary } from './services/transaction.service.js?v=20260729-13';
import { getCurrentUser, login, logout, restoreSupabaseSession } from './services/auth.service.js?v=20260729-13';
import { hasPermission } from './services/permission.service.js?v=20260729-13';
import { applyCompanyIdentity, loadCompanySettings, loadCompanySettingsLocal } from './services/empresa-config.service.js?v=20260729-13';
import { renderLoginModule } from './modules/auth/login.module.js?v=20260729-13';

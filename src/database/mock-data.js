...
export const mockProducts = [
  { id: 'x-burger', name: 'X-Burger', categoryId: 'lanches', price: 16, cost: 8.5, stock: 24, active: true },
  ...
  { id: 'batata-frita', name: 'Batata Frita', categoryId: 'porcoes', price: 14, cost: 6, stock: 18, active: true },
  { id: 'frango-passarinho', name: 'Frango a Passarinho', categoryId: 'porcoes', price: 28, cost: 16, stock: 10, active: true },
  { id: 'refrigerante-lata', name: 'Refrigerante Lata', categoryId: 'bebidas', price: 6, cost: 3.2, stock: 48, active: true },
  ...
  { id: 'combo-casal', name: 'Combo Casal', categoryId: 'combos', price: 48, cost: 25, stock: 8, active: true },

...
create or replace function private.products_manage_permission_id()
returns text
language sql
immutable
set search_path = ''
...
create or replace function private.cashier_access_permission_id()
returns text
language sql
immutable
set search_path = ''
...
create or replace function private.sale_cancel_permission_id()
returns text
language sql
immutable
set search_path = ''
...
create or replace function private.cash_movement_create_permission_id()
returns text
language sql
immutable
set search_path = ''
...
create or replace function private.stock_create_permission_id()
returns text
language sql
immutable
set search_path = ''
...
create policy "product managers insert categories" on public.categories
  for insert to authenticated with check (private.current_profile_has_permission(private.products_manage_permission_id()));
create policy "product managers update categories" on public.categories
  for update to authenticated using (private.current_profile_has_permission(private.products_manage_permission_id())) with check (private.current_profile_has_permission(private.products_manage_permission_id()));
...
create policy "sale cancelers update own sales" on public.sales
  for update to authenticated using (private.current_profile_has_permission(private.sale_cancel_permission_id()) and created_by = auth.uid()) with check (private.current_profile_has_permission(private.sale_cancel_permission_id()) and created_by = auth.uid());
...
create policy "cash movement creators insert cash movements" on public.cash_movements
  for insert to authenticated with check (private.current_profile_has_permission(private.cash_movement_create_permission_id()) and created_by = auth.uid());

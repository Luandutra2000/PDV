...
const categoryAdapter = await import('../src/services/repositories/financial-category.adapter.js?v=20260729-13');
const transactionAdapter = await import('../src/services/repositories/financial-transaction.adapter.js?v=20260729-13');

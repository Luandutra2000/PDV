...
const appSource = await readFile(new URL('../src/app.js?v=20260804-04', import.meta.url), 'utf8');
const onlineDataSource = await readFile(new URL('../src/services/online-data.service.js?v=20260804-04', import.meta.url), 'utf8');
const dashboardSource = await readFile(new URL('../src/modules/dashboard/dashboard.module.js?v=20260804-04', import.meta.url), 'utf8');
const estoqueSource = await readFile(new URL('../src/modules/estoque/estoque.module.js?v=20260804-04', import.meta.url), 'utf8');
const mobileSource = await readFile(new URL('../src/modules/mobile/mobile-dashboard.module.js?v=20260804-04', import.meta.url), 'utf8');
const supabaseProviderSource = await readFile(new URL('../src/services/providers/supabase.provider.js?v=20260804-04', import.meta.url), 'utf8');

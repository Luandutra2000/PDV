...
assert(indexHtml.includes('./src/app.js?v=20260610-02'), 'app entrypoint should use the latest cache-busting version');
...
assert(serviceWorkerJs.includes('pdv-v46'), 'service worker cache name should change when app modules change');
assert(serviceWorkerJs.includes('./src/app.js?v=20260610-02'), 'service worker should precache the latest app entrypoint');

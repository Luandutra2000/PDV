...
assert(indexHtml.includes('./src/app.js?v=20260729-03'), 'app entrypoint should use the latest cache-busting version');
...
assert(serviceWorkerJs.includes('./src/app.js?v=20260729-03'), 'service worker should precache the latest app entrypoint');

...
assert(indexHtml.includes('./src/app.js?v=20260601-02'), 'app entrypoint should use the latest cache-busting version');
...
assert(appJs.includes('./modules/mobile/mobile-dashboard.module.js?v=20260601-02'), 'mobile dashboard import should use the latest cache-busting version');
assert(mobileDashboardJs.includes('../../services/mobile-notifications.service.js?v=20260601-02'), 'mobile feed service import should use the latest cache-busting version');

...
assert(indexHtml.includes('./src/app.js?v=20260617-01'), 'app entrypoint should use the latest cache-busting version');
...
assert(serviceWorkerJs.includes('pdv-v53'), 'service worker cache name should change when app modules change');
assert(serviceWorkerJs.includes('./src/app.js?v=20260617-01'), 'service worker should precache the latest app entrypoint');

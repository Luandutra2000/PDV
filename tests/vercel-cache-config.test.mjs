...
assert(indexHtml.includes('./src/app.js?v=20260616-03'), 'app entrypoint should use the latest cache-busting version');
...
assert(serviceWorkerJs.includes('pdv-v50'), 'service worker cache name should change when app modules change');
assert(serviceWorkerJs.includes('./src/app.js?v=20260616-03'), 'service worker should precache the latest app entrypoint');
...
assert(mobileDashboardJs.includes('../../services/mobile-notifications.service.js?v=20260608-14'), 'mobile feed service import should use the latest cache-busting version');

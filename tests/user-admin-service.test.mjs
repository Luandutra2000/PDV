...
const supabaseClient = await import('../src/services/supabase-client.service.js?v=20260804-04');
const { STORAGE_KEYS, UI_EVENTS } = await import('../src/database/schema.js?v=20260804-04');
const userAdmin = await import('../src/services/user-admin.service.js?v=20260804-04');

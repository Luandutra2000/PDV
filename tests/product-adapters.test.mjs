...
const productAdapter = await import('../src/services/repositories/product.adapter.js?v=20260804-06');
const categoryAdapter = await import('../src/services/repositories/category.adapter.js?v=20260804-06');

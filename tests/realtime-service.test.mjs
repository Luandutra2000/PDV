...
const { STORAGE_KEYS, SYNC_EVENTS, UI_EVENTS } = await import('../src/database/schema.js?v=20260804-02');
const { emit, on } = await import('../src/services/event-bus.service.js?v=20260804-02');
const realtime = await import('../src/services/realtime.service.js?v=20260804-02');

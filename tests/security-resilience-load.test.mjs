...
const backup = await import('../src/services/backup.service.js?v=20260804-02');
const { renderProductCard } = await import('../src/components/product-card.component.js?v=20260804-02');
const { renderOrderPanel } = await import('../src/components/order-panel.component.js?v=20260804-02');
const { seedTestAdmin, setTestUserSession } = await import('./test-auth-fixture.mjs?v=20260804-02');

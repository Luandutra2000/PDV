...
const notifications = await import('../src/services/mobile-notifications.service.js?v=20260804-05');
...
storage.setItem((await import('../src/database/schema.js?v=20260804-05')).STORAGE_KEYS.transactions, [
  {
    id: 'sale-yesterday',
    type: 'venda',
    status: 'ativa',
...
storage.setItem((await import('../src/database/schema.js?v=20260804-05')).STORAGE_KEYS.stockLaunches, []);

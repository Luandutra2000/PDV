...
const notifications = await import('../src/services/mobile-notifications.service.js?v=20260729-13');
...
storage.setItem((await import('../src/database/schema.js?v=20260729-13')).STORAGE_KEYS.stockLaunches, []);

...
const productWithUntrustedFields = products.createProduct({
  id: 'untrusted-id',
...
assert(productWithUntrustedFields.id.startsWith('produto-validado'), 'product id should be generated by the service');
assert(productWithUntrustedFields.adminOnly === undefined, 'unknown product fields should not be persisted');

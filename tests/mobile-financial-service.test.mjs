...
const sync = await import('../src/services/financial-sync.service.js?v=20260729-13');
const mobileFinance = await import('../src/services/mobile-financial.service.js?v=20260729-13');

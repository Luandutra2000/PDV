...
const sync = await import('../src/services/financial-sync.service.js?v=20260804-02');
const mobileFinance = await import('../src/services/mobile-financial.service.js?v=20260804-02');

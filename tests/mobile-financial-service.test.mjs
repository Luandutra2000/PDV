...
const sync = await import('../src/services/financial-sync.service.js?v=20260804-06');
const mobileFinance = await import('../src/services/mobile-financial.service.js?v=20260804-06');
